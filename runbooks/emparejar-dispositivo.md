...
- [ ] El dispositivo esta en `catalogo/dispositivos.yaml`. Si no esta, **para**: se evalua primero
...
7. Regenerar: `python generador/generar.py clientes/<cliente>/cliente.yaml`.
