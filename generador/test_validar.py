...
defecto. Asi el fallo que se observa es atribuible a ese defecto y no a otra cosa.
    ...
    python -m unittest discover -s generador -p "test_*.py"
"""
...
class ADR001_CatalogoObligatorio(unittest.TestCase):
    def test_dispositivo_fuera_del_catalogo(self):
        ...
        inf = validar_dict(d)
        self.assertTrue(hay_error_con(inf, "no existe en catalogo/dispositivos.yaml"))
    ...
    def test_componente_de_software_fuera_del_catalogo(self):
        ...
        inf = validar_dict(d)
        self.assertTrue(hay_error_con(inf, "no existe en catalogo/software.yaml"))
...
class Red(unittest.TestCase):
    ...
    def test_paquete_inexistente(self):
        ...
        d["paquete"] = "XXL"
        inf = validar_dict(d)
        self.assertTrue(hay_error_con(inf, "no existe en paquetes/"))
