...
```bash
ansible-playbook -i herramientas-empresa/ansible/inventario/<cliente>.yml \
    herramientas-empresa/ansible/playbooks/aprovisionar-controlador.yml --tags base
```
...
python herramientas-empresa/generador/generar.py clientes/<cliente>/cliente.yaml
```
