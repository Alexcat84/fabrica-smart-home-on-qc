...
- [ ] Revisar el registro: si la camara caia **de noche y con frio**, sospechar del presupuesto PoE
      ...
      invierno. Ejecutar `python herramientas-empresa/calculadoras/calc_poe.py clientes/<cliente>/cliente.yaml` antes de
...
- [ ] **La camara no puede originar conexiones**: comprobar la regla direccional, no solo que "el
      video se ve".
- [ ] Recalcular almacenamiento si cambio el bitrate: `python herramientas-empresa/validador/validar.py ...`.
