...
def documento_calculos(cliente: dict, calculos: dict) -> str:
    ...
    lineas = [
        ...
        "anunciado.",
        "",
        "Su sistema usa **tres flujos de camara**, cada uno con un trabajo:",
        "",
        "| Flujo | Para que sirve |",
        "|---|---|",
        "| Principal | Grabar en el disco de su casa. No se envia por internet salvo que usted lo pida |",
        "| Medio | Abrir **una** camara cuando esta fuera |",
        "| Sub | Deteccion, y la vista de todas las camaras a la vez |",
        "",
        "Se comprueban **tres escenarios**. Los dos primeros tienen que caber; el tercero es una",
        "excepcion que usted pide a mano:",
        "",
        "1. **Cuadricula**: todos los visores previstos viendo todas las camaras a la vez.",
        "2. **Abrir una camara**: uno de ellos toca una camara para verla mejor. Es lo que",
        "   cualquiera hace en cuanto ve movimiento.",
        "3. **Abrir sobre el flujo principal**: calidad de grabacion, a peticion, para revisar algo",
        "   concreto. **Puede ir lento, y no es una averia**: esta pidiendo el mismo flujo que se",
        "   esta grabando en el disco.",
        "",
        "El bitrate de cada flujo se toma de la medicion de su sitio o del catalogo, nunca de un",
        "valor por defecto.",
        "",
        "```",
