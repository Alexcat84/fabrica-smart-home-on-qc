...
Uso:
    python herramientas-empresa/detectar_secretos.py archivo1 archivo2 ...
    python herramientas-empresa/detectar_secretos.py --todo
    python herramientas-empresa/detectar_secretos.py --preparados      # archivos en el indice de git
...
ARCHIVOS_EXENTOS = {"herramientas-empresa/detectar_secretos.py"}
